...
* subscriber ..0
* subscriberId ..0
* policyHolder only Reference($SD_Patient or $SD_RelatedPerson or $SD_Organization)
* beneficiary only Reference($SD_Patient)    //Can't disable elements that are mandatory by default
* dependent ..0
* relationship ..0
* period ..0
