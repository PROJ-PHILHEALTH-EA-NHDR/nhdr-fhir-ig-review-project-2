...
* identifier.assigner only Reference($SD_Organization)
...
// * length ..0
// * reasonCode ..0
* reasonReference only Reference($SD_Condition or $SD_Procedure or $SD_Observation)
...
* hospitalization.origin only Reference($SD_Location or PH_Organization)
* hospitalization.destination only Reference($SD_Location or PH_Organization)
* location.extension ..0
* location.modifierExtension ..0
* location.id ..0
* location.status ..0
* location.period ..0
* location.location only Reference($SD_Location)
