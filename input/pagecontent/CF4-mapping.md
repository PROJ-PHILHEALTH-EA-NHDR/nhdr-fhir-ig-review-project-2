...
| Condition.subject | Reference([PH_Patient](StructureDefinition-PH-Patient.html)) |  |
| ClinicalImpression.status | code |  |
| ClinicalImpression.subject | Reference([PH_Patient](StructureDefinition-PH-Patient.html)) |  |
